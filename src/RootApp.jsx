// v3.1 — HSI-first control center
import React, { useState } from 'react';
import { BrainCircuit, ClipboardList, Brain } from 'lucide-react';
...
const MODES = [
  ...
  { id:'builder', label:'Employee Builder',  sub:'Raw lens review',     Icon: ClipboardList, active:'border-fuchsia-300/40 bg-fuchsia-500/15'},
      ...
      <div className="relative mx-auto max-w-[96rem] px-4 py-5 sm:px-6 lg:px-8">
        <div className="mb-5 rounded-[2rem] border border-white/10 bg-white/[0.07] p-4 shadow-2xl shadow-black/20 backdrop-blur-xl">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-white/50">Human Systems Intelligence · 104 lenses × 17 PI profiles · Honest mapping workflow</p>
          </div>
